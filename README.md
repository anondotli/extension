...
*Note: The extension is currently in beta and can be installed manually.*

1. Download the latest release `.zip` for your browser from the **[Releases](../../releases)** page (or via GitHub Actions artifacts).
...
3. Select any file inside the unzipped extension directory (like `manifest.json`).
