          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-1 shrink-0">
                {/* QR code button */}
                {onOpenQr && (
                  <Button variant="ghost" size="icon" title="QR code" aria-label="Show QR code" onClick={() => handleQr(drop)}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                      <rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/>
                    </svg>
                  </Button>
                )}
                <Button variant="ghost" size="icon" title="Copy link" aria-label="Copy drop link" onClick={() => handleCopy(drop)}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>
                </Button>
                <Button variant="ghost" size="icon" title="Open in tab" aria-label="Open drop in new tab" onClick={() => handleOpen(drop)}>
                ...
                {confirmDelete === drop.id ? (
                  <button
                    ...
                    aria-label="Confirm delete drop"
                  >
